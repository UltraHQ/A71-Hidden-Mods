...
## ⚠️ I don't own the device anymore, this means I'm not able to push updates. In case this module starts bootlooping you, please boot into safe mode and remove it.</br></br>Booting into safe mode will disable all magisk modules, allowing you to enter the device again.
